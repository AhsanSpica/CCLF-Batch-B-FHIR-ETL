 ...
 */
@ResourceDef(name="Patient", profile="http://localhost/StructureDefinition/mypatient")
...
public class CustomPatient extends Patient {
     ...
     */
    @Child(name="petName")
    @Extension(url="http://localhost/dontuse#petname", definedLocally=false, isModifier=false)
    ...
    @Extension(url="http://localhost/dontuse#importantDates", definedLocally=false, isModifier=true)
